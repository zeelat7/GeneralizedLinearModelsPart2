...
# finalTestSet$P_TARGET_AMT <- -2.078127e+00 -
#   3.907767e-05 * finalTestSet$BLUEBOOK +
#   1.464413e-02 * finalTestSet$TRAVTIME +
#   2.155123e+00 * finalTestSet$URBANICITY +
#   7.557781e-01 * finalTestSet$REVOKED +
#   1.525968e-01 * finalTestSet$MVR_PTS -
#   5.258785e-02 * finalTestSet$TIF +
#   7.741312e-01 * finalTestSet$PARENT1 -
#   8.985781e-01 * finalTestSet$CAR_USE -
#   3.004051e-06 * finalTestSet$HOME_VAL
